...
[![Version](https://img.shields.io/badge/version-v0.38-2ea44f)](changelogs/v0.38.md)
...
```bash
docker pull nikolica/sideseat:v0.38
```

Digest izdanja:

```text
sha256:4f7a98251c9dfab4e8c1cd79b31c9d6241d9dee894774e3d0293965f637d05ec
```
