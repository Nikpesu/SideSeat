...
[![Version](https://img.shields.io/badge/version-v0.56-2ea44f)](changelogs/v0.56.md)
...
| --- | --- | --- | --- |
| [v0.52](changelogs/v0.52.md) | 2026-06-28 | Vraćena vidljivost završenih (samo asocirani); server TZ Europe/Zagreb (check-in/pokretanje rade); link na rezervaciju u Trenutnoj | `nikolica/sideseat:v0.52` |
| [v0.53](changelogs/v0.53.md) | 2026-06-29 | Ispravak slanja lokacije pri check-inu (invarijantno parsiranje koordinata, hr-HR zarez više ne odbacuje točku) | `nikolica/sideseat:v0.53` |
| [v0.54](changelogs/v0.54.md) | 2026-06-29 | Pouzdanije geolociranje pri check-inu (mrežna lokacija, 12 s timeout, gumb pokazuje napredak) | `nikolica/sideseat:v0.54` |
| [v0.55](changelogs/v0.55.md) | 2026-06-29 | Prekidač teme u navigaciji prikazuje samo ikonu (bez teksta Light/Dark) | `nikolica/sideseat:v0.55` |
...
| [v0.48](changelogs/v0.48.md) | 2026-06-28 | AI akcije vode na predpopunjenu stranicu umjesto izvršavanja u chatu | `nikolica/sideseat:v0.48` |
...
| [v0.43](changelogs/v0.43.md) | 2026-06-17 | Autići 1 km/s, spori zoom-tour i bufferana karta bez crnog ekrana | `nikolica/sideseat:v0.43` |
| [v0.42](changelogs/v0.42.md) | 2026-06-17 | Kamera zoom in/out tour i novi autić na istoj ruti 2 s nakon dolaska | `nikolica/sideseat:v0.42` |
| [v0.41](changelogs/v0.41.md) | 2026-06-17 | Vraćeno trenutno okretanje autića i minimalno 5 s po ruti | `nikolica/sideseat:v0.41` |
