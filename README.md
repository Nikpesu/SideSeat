...
[![Version](https://img.shields.io/badge/version-v0.42-2ea44f)](changelogs/v0.42.md)
...
```text
nikolica/sideseat:v0.42
```

Tag `latest` pokazuje na isto izdanje. Image je namijenjen platformi `linux/amd64`.

```bash
docker pull nikolica/sideseat:v0.42
```

Digest izdanja:

```text
sha256:02a4bc73750e50bac466106cd868a97815d3e2b6be16f0a1197ffdaef720b008
```
